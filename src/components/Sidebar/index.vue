<template>
  <div :class="this.$store.themeSettingsStore.semidark ? 'dark' : ''">
    ...
    >
      <div
        :class="`logo-segment flex justify-between items-center bg-white dark:bg-slate-800 z-[9] py-6  fixed top-0   px-4  ${
          this.$store.themeSettingsStore.sidebarCollasp
            ? this.closeClass
            : this.openClass
        } ${
      ...
      <SimpleBar
        class="sidebar-menu px-4 h-[calc(100%-80px)]" style="margin-top: 70px;"
        @created="
          (instance) => {
