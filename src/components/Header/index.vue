      ...
      <div class="flex justify-between items-center h-full">
        ...
        >
          ...
          <div class="flex items-center space-x-2">
            <button @click="minimizeClicked" class="">
              <Icon icon="material-symbols:minimize" class="w-4 h-4" />
            </button>
            <button @click="maximizeClicked" class="">
              <Icon icon="solar:maximize-bold" class="w-4 h-4" />
            </button>
            <button @click="exitClicked" class="">
...
export default {
  ...
  methods: {
    ...
    maximizeClicked() {
      ipcRenderer.send('maximize-clicked')
    },
    exitClicked() {
